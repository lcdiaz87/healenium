...
| (intermedia) | *(comprobación)* | Consulta Postgres y verifica que la huella existe |
...
Esto no es paranoia: Healenium guarda las huellas **sin esperar respuesta** (*fire-and-forget*). Si el backend todavía está arrancando, la fase 1 pasa en verde sin haber aprendido nada, y el síntoma solo aparece después. Me pasó durante el desarrollo y me costó un rato entenderlo, así que lo dejé comprobado explícitamente.
